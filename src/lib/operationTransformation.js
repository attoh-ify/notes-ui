...
export class OperationTransformation {
    static transformOperation(op1, op2) {
        ...
        if (op1Name === operation.INS && op2Name === operation.INS)
            return OperationTransformation.transformII(op1, op2);
        else if (op1Name === operation.INS && op2Name === operation.DEL)
            return OperationTransformation.transformID(op1, op2);
        else if (op1Name === operation.DEL && op2Name === operation.INS)
            return OperationTransformation.transformDI(op1, op2);
        else if (op1Name === operation.DEL && op2Name === operation.DEL)
