...
const features = [
  {
    ...
    text: "Write with your team in real time without losing review context.",
  },
  {
    icon: ShieldCheck,
    title: "Clear permissions",
    text: "Keep notes private, public, or shared with viewer/editor roles.",
  },
  {
    icon: FileText,
    title: "Version-aware notes",
    text: "Review changes and audit history with a focused writing experience.",
  },
];
      ...
      <header className="border-b border-slate-200/80 bg-white/80 backdrop-blur">
        <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="rounded-xl px-4 py-2 text-sm font-bold text-slate-600 transition hover:bg-slate-100 hover:text-slate-950"
            >
              Sign in
            </Link>
            <Link
              href="/register"
              className="hidden rounded-xl bg-emerald-600 px-4 py-2 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-700 sm:inline-flex"
            >
              Get started
            </Link>
          </div>
        ...
        <section className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              Notes gives teams a simple, professional space for real-time
              writing, permissions, review mode, and audit-friendly
              collaboration.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/register"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-emerald-600 px-6 py-3 text-base font-black text-white shadow-lg shadow-emerald-900/15 transition hover:bg-emerald-700"
              >
                Start writing free <ArrowRight size={18} />
              </Link>
              <Link
                href="/login"
                className="inline-flex min-h-12 items-center justify-center rounded-2xl border border-slate-200 bg-white px-6 py-3 text-base font-black text-slate-700 shadow-sm transition hover:bg-slate-50"
              >
            ...
            <div className="mt-10 flex flex-wrap gap-3 text-sm font-bold text-slate-500">
              <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-2 ring-1 ring-slate-200">
                <Users size={16} className="text-emerald-600" /> Team access
              </span>
              <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-2 ring-1 ring-slate-200">
                <Globe2 size={16} className="text-emerald-600" /> Public/private
                notes
              </span>
              <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-2 ring-1 ring-slate-200">
                <ShieldCheck size={16} className="text-emerald-600" />{" "}
                Review-safe workflow
              </span>
            </div>
          </div>
            ...
            <div className="rounded-[1.5rem] bg-slate-950 p-4 text-white">
              ...
              <div className="space-y-3 rounded-2xl bg-white p-4 text-slate-800">
                ...
                <div className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-sm font-semibold text-amber-800">
                  Audit changes ready for review
                </div>
